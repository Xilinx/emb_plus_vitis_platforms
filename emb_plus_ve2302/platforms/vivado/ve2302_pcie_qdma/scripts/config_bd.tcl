...
proc create_hier_cell_blp { parentCell nameHier} {
  ...
  set_property -dict [list \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      SMON_VAUX_CH0 {{ALARM_ENABLE 0} {ALARM_LOWER 0} {ALARM_UPPER 1} {AVERAGE_EN 0} {ENABLE 0} {IO_N LPD_MIO25_502} {IO_P LPD_MIO24_502} {MODE {1 V unipolar}} {NAME VAUX_CH0} {SUPPLY_NUM 10}} \
    } \
  ] $cips
